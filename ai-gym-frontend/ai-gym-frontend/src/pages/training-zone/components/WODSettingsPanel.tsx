...
import { WODData } from '../WODBuilder'

interface WODSettingsPanelProps {
  wodData: WODData
  onUpdate: (data: WODData) => void
}
...
export function WODSettingsPanel({ wodData, onUpdate }: WODSettingsPanelProps) {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h2 className="text-lg font-semibold text-gray-900 mb-4">WOD Settings</h2>
        <p className="text-sm text-gray-600 mb-6">
          Configure your WOD metadata and targeting
        </p>
      </div>
      ...
      {/* WOD Configuration */}
      <div className="space-y-4 border-t border-gray-200 pt-4">
        <h3 className="font-medium text-gray-900">WOD Configuration</h3>
