...
import { supabase, ContentItem, Community, UserTag, User } from '../../lib/supabase'
...
function AssignmentModal({ isOpen, onClose, community, contentItemId, onSave }: AssignmentModalProps) {
      ...
      <div className="bg-white rounded-xl max-w-2xl w-full max-h-[80vh] overflow-y-auto shadow-2xl">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-xl font-semibold text-gray-900">Assign to {community.name}</h2>
            ...
            {tags.length === 0 && users.length === 0 && (
              <div className="text-center py-8">
                ...
                <p className="text-xs text-gray-500 mt-1">
                  This community has no users or tags configured. Set up users and tags first.
                </p>
              </div>
            )}
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-gray-900">Community Assignment</h3>
                  <span className="text-sm text-gray-500">
                    {assignedCommunities.length} of {communities.length}
                  </span>
                </div>
                        ...
                        <div key={community.id} className="flex items-center justify-between p-3 border border-gray-200 rounded-lg hover:bg-gray-50">
                          <div className="flex items-center space-x-3">
                            <input
                              type="checkbox"
                              checked={isAssigned}
                              onChange={() => toggleCommunityAssignment(community.id)}
                              className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                            />
                            <div className="flex items-center space-x-2">
                              <div 
                          ...
                          {isAssigned && (
                            <button
                              onClick={() => setActiveAssignmentModal(community.id)}
        ...
        {activeAssignmentModal && (
          <ErrorBoundary>
            <AssignmentModal
              ...
              community={communities.find(c => c.id === activeAssignmentModal)!}
