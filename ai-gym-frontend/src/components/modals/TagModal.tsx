...
export function TagModal({ isOpen, onClose, onSuccess, tag, communities }: TagModalProps) {
          ...
          <div>
            ...
            {selectedCommunity && (
              <div className="mt-2 flex items-center space-x-2 text-sm text-gray-600">
                <Building2 className="h-4 w-4" style={{ color: selectedCommunity.brand_color }} />
                <span>{selectedCommunity.project_name}</span>
              </div>
            )}
          </div>
