...
interface DeployedLeftMenuProps {
  ...
  onClose: () => void
  wodData: WODData
  onWodDataUpdate: (data: WODData) => void
}
        ...
        return (
          <div className="p-6">
            ...
            <p className="text-sm text-gray-600 mb-6">
              Basic building blocks for your WOD content
            </p>
          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              ...
              ">
                ...
                <div className="text-sm text-gray-600">Add a new page to this WOD</div>
              </button>
