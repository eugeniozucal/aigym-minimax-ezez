...
export function AnalyticsDashboard() {
  ...
  const getSelectedClient = () => {
    if (filters.clientId === 'all') return 'All Clients'
    return clients.find(c => c.id === filters.clientId)?.name || 'Unknown Client'
  }
                  ...
                  <div className="py-1">
                    <button
                      ...
                      className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-50 ${
                        filters.clientId === 'all' ? 'bg-blue-50 text-blue-700' : 'text-gray-700'
                      }`}
                    >
                      All Clients
                    </button>
                    {clients.map((client) => (
                      <button
                        ...
                        className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-50 ${
                          filters.clientId === client.id ? 'bg-blue-50 text-blue-700' : 'text-gray-700'
                        }`}
                      >
                        {client.name}
                      </button>
