  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (authData.user) {
        ...
        // Redirect community users to their user dashboard, not admin login
        setTimeout(() => {
          navigate('/login?message=Welcome! Please sign in to access your community.');
        }, 3000);
      } else {
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md w-full bg-white rounded-lg shadow-md p-8 text-center">
          ...
          <p className="text-sm text-gray-500 mb-6">
            Please check your email to verify your account, then you can sign in to access your community dashboard.
          </p>
