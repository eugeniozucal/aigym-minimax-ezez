...
export function Login() {
  ...
  // Smart routing: if user is already logged in, route them to appropriate dashboard
  if (user) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Note: Don't set loading to false on success - let auth state change handle redirect
  }
